...
class CircleDetection:
    ...
    def INPUT_TYPES(cls):
        ...
        return {
            "required": {
                ...
                "exclude": ("STRING", {"multiline": False, "default": ""}),
            }
        }
    ...
    def circle_detection(self, image, threshold_canny_edge, threshold_circle_center, minR, maxR, minDist, dp, color_tuple_circle, color_tuple_bg, color_tuple_fg, thickness, exclude):
